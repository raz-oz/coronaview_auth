...
/**
 * Create a builder that takes a message and builds an Amazon PublishRequest.
 */
public class RequestBuilder
{
	...
	public static PublishRequest build(String topicArn, Message message)
	{
		...
		PublishRequest request = PublishRequest.builder().topicArn(topicArn).message(DEFAULT_MESSAGE_BODY).messageAttributes(attributes).build();
		return request;
	}
